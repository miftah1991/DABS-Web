...
<div class="row" style="min-height: 300px; vertical-align:bottom; border-radius:2% 2% 2% 2%; margin-bottom:0px;">
<table class="hover" align="center" width="95%">  
  ...
  <?php foreach($jobs as $j){  ?>
    ...
    <td><a href="<?php base_url(); ?>Jobs/JobDetail/<?php echo $j->jid; ?>"><?php echo $j->position_title; ?></a></td>
