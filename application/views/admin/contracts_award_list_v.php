	...
	<section id="main" class="column">
		...
		<?PHP endif; ?>
            	<article class="module width_3_quarter">
                    <header>
                      <h3 class="tabs_involved">Contracts Award Manager</h3></header>
                    <div class="">
                    ...
                    <tr>
                      ...
                      <th width="137">Contract Number</th>
                      <th width="211">Description</th>
                      <th width="120" class="tex">Awarded To</th>
                      <th width="116" class="tex">Publish Date</th>
                    ...
                    <tr>
                      ...
                      <td><?PHP echo $row->awarded_to; ?></td>
                      <td><?PHP echo $row->publish_date; ?></td>
                     
                      <td><a href="<?php echo base_url(); ?>admin/ContractsAward/Edit/<?PHP echo $row->id; ?>">
					 Edit</a></td>
                   <!--  <td><a href="<php echo base_url(); ?>admin/Tender/SendtoSubscrib/<PHP echo $row->tid; ?>">
					 SEND</a></td>   -->
                      <td><a href="<?php echo base_url(); ?>admin/ContractsAward/Delete/<?PHP echo $row->id; ?>" onclick="return confirm('Are you sure to delete Tender?');">
					 Delete</a></td>
                    </tr>
                    <?PHP
					endforeach;
