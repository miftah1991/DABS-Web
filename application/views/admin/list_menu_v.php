	...
	<section id="main" class="column">
		...
		<?PHP endif; ?>
            	<article class="module width_3_quarter">
                    <header>
                      <h3 class="tabs_involved">Menu Manager</h3></header>
                    <div class="">
                    ...
                    <tr>
                      ...
                      <td><a href="<?php echo base_url(); ?>admin/Menu/update_form/<?PHP echo $row->id; ?>">
					 Edit</a></td>
                      <td><a href="<?php echo base_url(); ?>admin/Menu/Delete/<?PHP echo $row->id; ?>" onclick="return confirm('Are you sure to delete Menu?');">
					 Delete</a></td>
                    </tr>
                    <?PHP
					endforeach;
