...
<script type="text/javascript" src="<?=base_url()?>Editor/jscripts/tiny_mce/tiny_mce.js"></script>
...
<body>
	<div id="container">
		...
		<?PHP endif; ?>
				...
				<header>
				  <h3>Edit Page</h3></header>
					<div class="module_content">

						<?PHP
							foreach($page as $p){
							echo form_open(base_url().'admin/Pages/update_page');
							?>
                            <fieldset>
                            <label>
                            PAGE Title
                            </label>
                            <?PHP echo form_input('title',$p->title,set_value('title')); ?><br />
                            ...
                            <?PHP echo form_input('custom_url',$p->custom_url,set_value('custom_url')); ?><br />
                            <?php echo form_error('custom_url', '<span class="ferror">', '</span>'); ?>
                            </fieldset>
                            <label style="font-weight:bold;">
                            CONTENT</label>
                            <?PHP echo form_textarea('contents',$p->contents,set_value('contents')); ?>
                            <?php echo form_error('contents', '<span class="ferror">', '</span>'); ?>
                            
                            <fieldset>
                            <input type="hidden" name="page_id" value="<?php echo $p->page_id; ?>" id="page_id" />
