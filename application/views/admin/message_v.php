	...
	<section id="main" class="column">
		...
		<?PHP endif; ?>
            	<article class="module width_3_quarter">
                    <header>
                      <h3 class="tabs_involved">Messages Manager</h3></header>
                    <div class="">
                    ...
                    <tr>
					  ...
					  $this->db->where('language_id', $m->language_id);
					  // here we select every column of the table
					  $q = $this->db->get('tbl_lng');
					  $data = $q->result_array();
					  
					  echo($data[0]['language']);
					 ...
					 ?></td>
                      ...
                      <td><a href="<?php echo base_url(); ?>admin/Messages/EditMessage/<?PHP echo $m->m_id; ?>">
					 Edit</a></td>
                      <td><a href="<?php echo base_url(); ?>admin/Messages/Delete/<?PHP echo $m->m_id; ?>" onclick="return confirm('Are you sure to delete File?');">
					 Delete</a></td>
                    </tr>
                    <?PHP
					endforeach;
