...
<body>
	<div id="container">
		...
		<?PHP endif; ?>
				...
				<header>
				  <h3>ADD NEW JOB</h3></header>
					<div class="module_content">
					  <?PHP
							echo form_open(base_url().'admin/job/add_job');
							?>
					  <fieldset>
					 <label> Vacancy Number:</label>
					  		<?PHP echo form_input('vacancy_num',set_value('vacancy_num')); ?><br />
                            <?php echo form_error('vacancy_num', '<span class="ferror">', '</span>'); ?>
                      </fieldset>
                            
                      <fieldset>
                             <label> Position Title:</label>
							 <?PHP echo form_input('position_title',set_value('position_title')); ?><br />
            ...
            <option value="Travel/Tourism" <?php echo set_select('functional_area','Travel/Tourism', TRUE); ?>>Travel/Tourism</option>
              ...
              <option value="Zabul" <?php echo set_select('province','Zabul', TRUE); ?>>Zabul</option>          
                         ...
                         <fieldset>
				<?php	echo form_checkbox('travel_province', 1 ,set_checkbox('travel_province', '1')); ?>
                     Require Trvael To Other Province ?                     
                     </fieldset> 
                      <fieldset>
                        <label>Publish Date</label>
                       <input type="text" name="publish_date" value="<?php echo set_value('publish_date'); ?>" id="publish_date"  />
                         <br />
                     ...
                     <fieldset>
                        ...
                        <input type="text" name="expire_date" value="<?php echo set_value('expire_date'); ?>" id="expire_date"  /> 
                        <br />
                    ...
                    <option value="6 months probation" <?php echo set_select('probition_period','6 months probation', TRUE); ?>>6 months probation</option>
                     ...
                     <fieldset>
                        ...
                        <?PHP echo form_input('duration','0 Year && 0 Months',set_value('duration')); ?><br />
                     ...
                     <fieldset>
                        <label>Gender</label>
                        <select name="gender">
                        <option value="Any"  <?php echo set_select('gender','Any', TRUE); ?>>Any</option>
                     ...
                     <fieldset>
                        <label>Salary</label>
                        <?PHP echo form_input('salary',0,set_value('salary'))."<br>"; 
						echo form_checkbox('salry_negotiable', 1,set_checkbox('salry_negotiable', '1')); ?>
            ...
            <option value="Doctorate" <?php echo set_select('education','Doctorate', TRUE); ?>>Doctorate</option>
                     ...
                     <fieldset>
                        ...
                        <?PHP echo form_input('education_field',set_value('education_field')); ?> <br />
                            <?php echo form_error('education_field', '<span class="ferror">', '</span>'); ?>                  
                     </fieldset> 
                     <fieldset>
                        <label>Skills Required</label>
                        <?PHP echo form_textarea('skills_required',set_value('skills_required')); ?><br />
                            <?php echo form_error('skills_required', '<span class="ferror">', '</span>'); ?>                   
                     </fieldset> 
                     <fieldset>
                        <label>Language Required</label>
                        <?PHP echo form_input('language_required',set_value('language_required')); ?><br />
                            <?php echo form_error('language_required', '<span class="ferror">', '</span>'); ?>                   
                     </fieldset> 
                     <fieldset>
                        <label>Duties &amp; Responsibilities</label>
                        
                        <?PHP echo form_textarea('duties',set_value('duties')); ?> <br />
                            <?php echo form_error('duties', '<span class="ferror">', '</span>'); ?>                  
                     </fieldset>
                     <fieldset>
                        <label>Qualification</label>
                        <?PHP echo form_textarea('qualification',set_value('qualification')); ?>
                        <br />
