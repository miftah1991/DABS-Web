...
<body>
	<div id="container">
		...
		<?PHP endif; ?>
				...
				<header>
				  <h3>ADD NEW Contract Award</h3></header>
					<div class="module_content">
                    <?php
$attributes = array('id' => 'form1','name' =>'form1');

 echo form_open_multipart(base_url().'admin/ContractsAward/ProcessContractsAward',$attributes);?>

  <table class="bordered">
    <fieldset>
					 <label> Contract Number:</label>
					  		<?PHP echo form_input('contract_number',set_value('contract_number')); ?><br />
                            <?php echo form_error('contract_number', '<span class="ferror">', '</span>'); ?>
                      </fieldset>
                            
                      <fieldset>
                             <label> Description:</label>
							 <?PHP echo form_input('description',set_value('description')); ?><br />
                      ...
                      <fieldset>
                        ...
                        <input type="text" name="publish_date" id="t_start_date" value="<?php echo set_value('publish_date'); ?>" readonly  />
                         <br />
                      ...
                      <fieldset>
                        ...
                        <?PHP echo form_input('awarded_to',set_value('awarded_to')); ?> <br />
				   ...
				   <fieldset>
					Contracts Award Deatil
					  <textarea name="contracts_award_details" cols="50" style="height:200px;" ><?php echo set_value('contracts_award_details'); ?></textarea>
					</fieldset>
					<fieldset>
