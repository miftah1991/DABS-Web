				...
				<header>
				  <h3>Add New file to Webiste.</h3></header>
					<div class="module_content">
						...
						<?PHP
							echo form_open_multipart(base_url().'admin/media/add_media');
							?>
                            <fieldset>
                            <label>
                            File Title
                           ...
                           <span class="ferror"> <?php echo @$error; ?></span>
                            ...
                            <option value="DOC" selected="selected">WORD DOCUMENT</option> 
                            ...
                            <?PHP echo form_input('date',set_value('date')); ?><br />
