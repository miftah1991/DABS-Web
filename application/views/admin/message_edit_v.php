...
<div id="container">
				...
				<header>
				  <h3>Update Message Details.</h3></header>
					<div class="module_content">

						<?PHP
							foreach($msg as $m){
							echo form_open_multipart(base_url().'admin/messages/update_message/');
							?>
                            <fieldset>
                            <label>
                            Message Title
                            </label>
                            <?PHP echo form_input('m_title',$m->m_title,set_value('m_title')); ?><br />
                            ...
                            <?PHP echo form_input('m_text',$m->m_text,set_value('m_text')); ?><br />
                           ...
                           <select name="language_id">
                            ...
                            <?PHP echo form_input('m_link',$m->m_link,set_value('m_link')); ?><br />
                            <?php echo form_error('m_link', '<span class="ferror">', '</span>'); ?>
               				</select>
                            </fieldset>
                            <input type="hidden" name="m_id" value="<?php echo $m->m_id; ?>" />
