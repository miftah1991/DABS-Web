...
<div id="container">
				...
				<header>
				  <h3>EDIT SlideShow Item.</h3></header>
					<div class="module_content">

						<?PHP	foreach($sld as $s){
							echo form_open_multipart(base_url().'admin/Slides/update_slide');
							?>
                            <fieldset>
                            <label>
                            Text
                            </label>
                            <?PHP echo form_input('text',$s->text,set_value('text')); ?><br />
                            <?php echo form_error('text', '<span class="ferror">', '</span>'); ?>
                            </fieldset>
                            <fieldset>
                            <label>
                           Language
