...
<td width="10%"><img class="top-hedar-img" src="<?php echo base_url(); ?>images/logo.png" style="width:80px; height:80px;" alt="Afghanistan"/></td>
	...
	<div id="container">
				...
				<header>
				  <h3>Add New file to Webiste.</h3></header>
					<div class="module_content">

						<?PHP
							foreach($file as $f){
							echo form_open_multipart(base_url().'admin/media/update_media/');
							?>
                            <fieldset>
                            <label>
                            File Title
                            </label>
                            <?PHP echo form_input('title',$f->title,set_value('title')); ?><br />
                           ...
                           <span class="ferror"> <php echo @$error; ?></span>
                            ...
                            <option value="<?php echo $f->type; ?>" selected="selected"><?php echo $f->type; ?></option>
                            ...
                            <?PHP echo form_input('date',$f->date,set_value('date')); ?><br />
