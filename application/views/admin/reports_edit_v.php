...
<body>
	...
	<?php  foreach($rpt as $r) { ?>
<form action="<?php echo base_url(); ?>admin/reports/update_report" method="post" name="form1" id="form1">
  <table class="bordered">
    <fieldset>
					 <label> Report Title:</label>
					  		<?PHP echo form_input('rtitle',$r->rtitle,set_value('rtitle')); ?><br />
                       ...
                       <fieldset>
                            ...
                            <select name="type">
                         <option value="<?php echo $r->type; ?>"><?php echo $r->type; ?> Reports</option>
                      ...
                      <fieldset>
                        ...
                        <?PHP echo form_input('rpublish_date',$r->rpublish_date,set_value('rpublish_date')); ?> <br />
   ...
   <fieldset>
    REPORT Deatil
    <?PHP echo form_textarea('rtext',$r->rtext,set_value('rtext')); ?>
         <input type="hidden" name="rid" value="<?php echo $r->rid; ?>"  id="rid"/>
...
<!-- <div class="dv_add"><a href="javascript:void(0);" id="anc_add_more">Add More File</a></div> -->
                ...
                <div id="status"></div>
                <form action="<?php echo base_url(); ?>admin/reports/do_upload" method="post" id='frm_upld' enctype="multipart/form-data">
                    <span id='spn_inputs'> 
