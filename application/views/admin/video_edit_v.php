				  ...
				  <h3>EDIT SlideShow Item.</h3></header>
					<div class="module_content">
						...
						<?PHP	foreach($videos as $v){
							echo form_open_multipart(base_url().'admin/Videos/update_video');
							?>
                            <fieldset>
                            <label>
                            Title
                            </label>
                            <?PHP echo form_input('v_title',$v->v_title,set_value('v_title')); ?><br />
                            ...
                            <?PHP echo form_input('v_code',$v->v_code,set_value('v_code')); ?><br />
