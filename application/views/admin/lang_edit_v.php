		...
		<?PHP endif; ?>
				...
				<header><h3>Add new language</h3></header>
					<div class="module_content">
						...
						foreach($fields as $r)
							{
							echo form_open(base_url().'admin/language/update/');
							?>
                            <fieldset>
                            <label>
                            Language
                            </label>
                            <?PHP echo form_input('language',$r->language, set_value('language')); ?><br />
                            ...
                            <?PHP echo form_input('code', $r->code, set_value('code')); ?><br />
                            ...
                            <?PHP $options = array('left'=>'Left','right'=>'Right');
									echo form_dropdown('align',$options,$r->align);
									?>
                            </fieldset>
                            <fieldset>
                            <label>
                            ...
                            <?PHP $options = array('rtl'=>'Right to Left','ltr'=>'Left to Right');
									echo form_dropdown('alignment',$options,$r->alignment);
									?>
                            </fieldset>
                            <fieldset>								
                            &nbsp;&nbsp;
								<?PHP echo form_checkbox('visible',1,$r->visible);?><strong>Visible ?</strong>
                            </fieldset>
                            <fieldset>								
                            &nbsp;&nbsp;
								<?PHP echo form_checkbox('default_language',1,$r->default_language);?><strong>Default Language ?</strong>
                            </fieldset>
                            <input type="hidden" name="language_id" value="<?php echo $r->language_id; ?>" />
                            <fieldset>
