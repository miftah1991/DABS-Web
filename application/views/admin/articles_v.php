	...
	<section id="main" class="column">
		...
		<?PHP endif; ?>
            	<article class="module width_3_quarter">
                    <header>
                      <h3 class="tabs_involved">ARTICLES Manager</h3></header>
                    <div class="">
                    ...
                    <tr>
                      ...
                      <td><a href="<?php echo base_url(); ?>admin/Articles/EditArticle/<?PHP echo $n->nid; ?>">
					 Edit</a></td>
                  <!--   <td><a href="<php echo base_url(); ?>admin/News/SendtoSubscrib/<PHP echo $n->nid; ?>">
					 SEND</a></td>  -->
                      <td><a href="<?php echo base_url(); ?>admin/Articles/Delete/<?PHP echo $n->nid; ?>" onclick="return confirm('Are you sure to delete Articles?');">
					 Delete</a></td>
                    </tr>
                    <?PHP
					endforeach;
