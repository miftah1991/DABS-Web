...
<div style="background-color:white; " class="medium-7 large-7 columns cl" data-equalizer-watch>
		...
		<?php } $i++;  } }?>
            ...
            <div style="text-align:justify; font-size:14px;"><?php echo substr($n1->text,0,600); ?>....
...
<div style="background-color:white; " class="medium-5 large-5 columns cl font13" data-equalizer-watch>
     ...
     <img src="<?php echo base_url(); ?>images/DABS-LOGO.jpg" style="float:left; margin:2px;" id="ceo-pic" alt="CEO">        
...
<div class="row" >
       ...
       <div class="callout large-3 columns" style="height: 470px;" >
		...
		<div>
		   <br><a href="<?php echo base_url() ?>News/NewsDetail/<?php echo $n2->nid; ?>"><h6><?php echo $n2->subtitle; ?></h6></a>
		</div>
        
		<div class="just_class" style="font-size:14px; word-spacing:1px; font-weight:normal;text-align:justify;">
		   <?php echo substr($n2->text,0,180); ?>.....
			<a href="<?php echo base_url()."News/NewsDetail/".$n2->nid; ?>">
			<?php foreach($dictionary as  $d){ echo $d->read_more; }?></a>
            <center style="position:absolute;bottom:0px;"><br><?php echo $n2->date; ?></center>
        </div>
        
    </div>
            <?php } ?>
			<div class="callout large-3 columns" style="padding:0px;" data-equalizer-watch >
                        <iframe  src="<?php echo base_url() ?>news_win_c/news" frameborder="0" border="0" width="100%" scrolling="No" height="470" allowtransparency="true" wrap> 
